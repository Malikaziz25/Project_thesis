 ...
 */
@Service
public class PrintItemAdjustmentReportService {
    @Autowired
    ...
    private Map<String, Object> getParameters(String operatorName){
        String compName = "";
        String compAddress = "";
        String compPhone = "";
        String compLogo = "";
        ...
        parameters.put("operatorName", operatorName);
    ...
    private JasperReport getJasperReport() throws FileNotFoundException, JRException {
        ...
        String reportFile = "reports/items.jrxml";
        JasperReport Jasp = JasperCompileManager.compileReport(reportFile);
        return Jasp;
    }
    private JRDataSource getDataSource(List<ItemAdjustementReportItem> result){
        
        
        return new JRBeanCollectionDataSource(result);
    }
    
    public void generateAndPrint(String operatorName, List<ItemAdjustementReportItem> result)throws JRException, FileNotFoundException, FontFormatException, IOException{
        ...
        Map<String, Object> parameters = getParameters(operatorName);
