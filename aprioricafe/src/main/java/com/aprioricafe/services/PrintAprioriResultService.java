 ...
 */
@Service
public class PrintAprioriResultService {
    @Autowired
    ...
    private JasperReport getJasperReport() throws FileNotFoundException, JRException {
        ...
        String reportFile = "reports/apriori-result.jrxml";
        JasperReport Jasp = JasperCompileManager.compileReport(reportFile);
        return Jasp;
    }
    private JRDataSource getDataSource(List<AssociationResultReportItem> result){
        
        
        return new JRBeanCollectionDataSource(result);
    }
    
    public void generateAndPrint(List<AssociationResultReportItem> result)throws JRException, FileNotFoundException, FontFormatException, IOException{
